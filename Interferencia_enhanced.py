# Esta es la versión mejorada del programa de interferencias
# En esta mejora se ha añadido otro widget que permite poner un número customizado de rejillas
# Para ello se ha cambiado la ecuación de difracción de Fraunhofer por 
        ### Ecuación de Fraunhofer con muchas rejillas con un for loop???


# También se va a añadir el espectro completo de color al mapa
# Se añade un gráfico de la intensidad respecto la posición de la pantalla
